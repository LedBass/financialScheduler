      ...
      <div class="container py-5">
        <div class="row">
          <div class="mx-auto col-lg-8 col-md-10">
            ...
            <h3>Escolha uma das ações disponíveis abaixo</h3>
              <a href="/principal/transactions/list/${user.id}" class="btn btn-lg btn-primary mx-1">Listar as transações existentes.</a>
